...
/*
  ...
  2. MARESSIA ANGEL FIRDAUS (2217051028)
  3. ZAHRATUL AINI ULFATUNNISA (2257051035)
*/
...
//fungsinya buat meletakkan teks tengah layar
{
...
void loading()
//fungsi ini sebagai program untuk bagian loading screen
{
    system("COLOR 0e");
    //untuk mewarnai teks kuning
    system("cls");
    //untuk membersihkan layar
    printf("\e[?25l");
    //untuk menginput simbol dari ASCII.
    
    SetConsoleCP(437);
    SetConsoleOutputCP(437);
    //untuk membuat loading bar
...
{	
	...
	centerPrint( 5, "oleh Kelompok 5 Kelas C" );
